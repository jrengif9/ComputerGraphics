...
void ofApp::setup() {
	...
	gui.add(clearBtn.setup("Borrar objetos"));
	gui.add(addSphere.setup("Agregar Esfera"));
	gui.add(addCone.setup("Agregar Cilindro"));
	gui.add(addBox.setup("Agregar Cubo"));
	gui.add(radius.setup("Radio", 45, 10, 300));
	gui.add(height.setup("Altura", 45, 10, 300));
	gui.add(width.setup("Anchura", 45, 10, 300));
	gui.add(depth.setup("Profundidad", 45, 10, 300));
